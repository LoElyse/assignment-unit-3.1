...
let favoriteFoods = ['gumbo', 'pasta', 'butter chicken'];
...
console.log('Favorite foods:', numberOfFoods);
...
let secondGem = gems.indexOf('Citrine');

if(secondGem !== -1) {
  gems[secondGem] = 'Tourmaline'  ;
}
console.log('Replaced second gem', secondGem)
...
let sortGems = gems.sort();
sortGems = gems.reverse();
console.log('Sorted gems as', sortGems);
console.log('Reversed gems as', sortGems);
console.log('Gems are now', gems);
...
//     Don't forget to console.log `gemString`...
 ...
 console.log('Joined gems as', gemString);
 console.log('Gems are now', gems);
...
let colorGems = gems.concat(colors);
console.log('New array is now',colorGems);
